...
@app.command()
def generate(
    project_identifier: str = typer.Argument(..., help="Project name (folder in projects/) or path to Summary.md"),
    output_dir: str = typer.Option(None, "--output", "-o", help="Custom output directory"),
