...
def main(project_name):
    ...
    log_path = os.path.join("projects", project_name, f"{project_name}_DSP_Generation_Log.json")
    if not os.path.exists(log_path):
        print(f"ERROR: Could not find the generation log at {log_path}. Please run the main generator script first.")
        return
